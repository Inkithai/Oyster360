...
def deck():
    c = canvas.Canvas("/home/user/Oyster360/submission/Oyster360_Pitch_Deck.pdf", pagesize=landscape(letter))
...
def brochure():
    c = canvas.Canvas("/home/user/Oyster360/submission/Oyster360_Brochure.pdf", pagesize=letter)  # portrait
    w, h = letter
    # Header band
